package io.onebrick.demo.web.scrapper.entity.constant;
...
public class TokopediaConstant {
  ...
  public static final String PRODUCT_LIST = "[data-testid='lstCL2ProductList']";
  ...
  public static final String PRODUCT_RATE = "[data-testid='lblPDPDetailProductRatingNumber']";
  public static final String PRODUCT_IMAGE = "img[crossorigin='anonymous']";
  public static final String SOURCE_ATTRIBUTE = "src";
  public static final String STORE_NAME = "[data-testid='llbPDPFooterShopName']";

  private TokopediaConstant() {
  }
}
